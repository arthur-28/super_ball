...
bmp_background = arcade.load_texture('img/dirt.png')
bmp_platform = arcade.load_texture('img/head.png')
bmp_ball = arcade.load_texture('img/kirka.png')
...
class Platform:
    ...
    def draw(self):
        arcade.draw_line(self.x - self.width / 2, self.y,
                         ...
                         self.color, 5)
        arcade.draw_texture_rectangle(self.x, self.y, self.width, self.height, bmp_platform)
